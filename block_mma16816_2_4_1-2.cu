...
block_mma(void* __restrict__ Cptr,
  ...
  /*printf("#if:A:bd:[%d,%d] td:[%d,%d] A[%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d] B[%d %d %d %d %d %d %d %d]\n",
      blockIdx.y,blockIdx.x,threadIdx.y,threadIdx.x,
      (int)float(tCrA(make_coord(0,0,0))),(int)float(tCrA(make_coord(1,0,0))),
      (int)float(tCrA(make_coord(2,0,0))),(int)float(tCrA(make_coord(3,0,0))),
      (int)float(tCrA(make_coord(4,0,0))),(int)float(tCrA(make_coord(5,0,0))),
      (int)float(tCrA(make_coord(6,0,0))),(int)float(tCrA(make_coord(7,0,0))),
      (int)float(tCrA(make_coord(8,0,0))),(int)float(tCrA(make_coord(9,0,0))),
      (int)float(tCrA(make_coord(10,0,0))),(int)float(tCrA(make_coord(11,0,0))),
      (int)float(tCrA(make_coord(12,0,0))),(int)float(tCrA(make_coord(13,0,0))),
      (int)float(tCrA(make_coord(14,0,0))),(int)float(tCrA(make_coord(15,0,0))),
      (int)float(tCrA(make_coord(16,0,0))),(int)float(tCrA(make_coord(17,0,0))),
      (int)float(tCrA(make_coord(18,0,0))),(int)float(tCrA(make_coord(19,0,0))),
      (int)float(tCrA(make_coord(20,0,0))),(int)float(tCrA(make_coord(21,0,0))),
      (int)float(tCrA(make_coord(22,0,0))),(int)float(tCrA(make_coord(23,0,0))),
      (int)float(tCrA(make_coord(24,0,0))),(int)float(tCrA(make_coord(25,0,0))),
      (int)float(tCrB(make_coord(0,0,0))),(int)float(tCrB(make_coord(1,0,0))),
      (int)float(tCrB(make_coord(2,0,0))),(int)float(tCrB(make_coord(3,0,0))),
      (int)float(tCrB(make_coord(4,0,0))),(int)float(tCrB(make_coord(5,0,0))),
      (int)float(tCrB(make_coord(6,0,0))),(int)float(tCrB(make_coord(7,0,0)))
    );*/
    /*printf("#if:tCrA:tCrB:bd:[%d,%d] td:[%d,%d] A[%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d] B[%d %d %d %d %d %d %d %d]\n",
        blockIdx.y,blockIdx.x,threadIdx.y,threadIdx.x,
        (int)float(tCrA(make_coord(0,0,0))),(int)float(tCrA(make_coord(1,0,0))),
        (int)float(tCrA(make_coord(2,0,0))),(int)float(tCrA(make_coord(3,0,0))),
        (int)float(tCrA(make_coord(4,0,0))),(int)float(tCrA(make_coord(5,0,0))),
      ...
      /*printf("#if:tArA:tBrB:bd:[%d,%d] td:[%d,%d] A[%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d] B[%d %d %d %d %d %d %d %d]\n",
          blockIdx.y,blockIdx.x,threadIdx.y,threadIdx.x,
          (int)float(tArA(make_coord(0,0,0))),(int)float(tArA(make_coord(1,0,0))),
          (int)float(tArA(make_coord(2,0,0))),(int)float(tArA(make_coord(3,0,0))),
          (int)float(tArA(make_coord(4,0,0))),(int)float(tArA(make_coord(5,0,0))),
          (int)float(tArA(make_coord(6,0,0))),(int)float(tArA(make_coord(7,0,0))),
          (int)float(tArA(make_coord(8,0,0))),(int)float(tArA(make_coord(9,0,0))),
          (int)float(tArA(make_coord(10,0,0))),(int)float(tArA(make_coord(11,0,0))),
          (int)float(tArA(make_coord(12,0,0))),(int)float(tArA(make_coord(13,0,0))),
          (int)float(tArA(make_coord(14,0,0))),(int)float(tArA(make_coord(15,0,0))),
          (int)float(tCrA(make_coord(16,0,0))),(int)float(tCrA(make_coord(17,0,0))),
          (int)float(tCrA(make_coord(18,0,0))),(int)float(tCrA(make_coord(19,0,0))),
          (int)float(tCrA(make_coord(20,0,0))),(int)float(tCrA(make_coord(21,0,0))),
          (int)float(tCrA(make_coord(22,0,0))),(int)float(tCrA(make_coord(23,0,0))),
          (int)float(tCrA(make_coord(24,0,0))),(int)float(tCrA(make_coord(25,0,0)))
          (int)float(tBrB(make_coord(0,0,0))),(int)float(tBrB(make_coord(1,0,0))),
          (int)float(tBrB(make_coord(2,0,0))),(int)float(tBrB(make_coord(3,0,0))),
          (int)float(tBrB(make_coord(4,0,0))),(int)float(tBrB(make_coord(5,0,0))),
          (int)float(tBrB(make_coord(6,0,0))),(int)float(tBrB(make_coord(7,0,0)))
        );*/
  ...
  for (int ik = 0; ik < NTilesK; ++ik) {
    ...
    printf("#elif:t:%d:A:bd:[%d,%d] td:[%d,%d] A[%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d] B[%d %d %d %d %d %d %d %d]\n",
          ik,blockIdx.y,blockIdx.x,threadIdx.y,threadIdx.x,
        (int)float(tArA(make_coord(0,0,0))),(int)float(tArA(make_coord(1,0,0))),
        (int)float(tArA(make_coord(2,0,0))),(int)float(tArA(make_coord(3,0,0))),
        (int)float(tArA(make_coord(4,0,0))),(int)float(tArA(make_coord(5,0,0))),
        (int)float(tArA(make_coord(6,0,0))),(int)float(tArA(make_coord(7,0,0))),
        ...
        (int)float(tArA(make_coord(12,0,0))),(int)float(tArA(make_coord(13,0,0))),
        (int)float(tArA(make_coord(14,0,0))),(int)float(tArA(make_coord(15,0,0))),
        (int)float(tArA(make_coord(16,0,0))),(int)float(tArA(make_coord(17,0,0))),
        (int)float(tArA(make_coord(18,0,0))),(int)float(tArA(make_coord(19,0,0))),
        (int)float(tArA(make_coord(20,0,0))),(int)float(tArA(make_coord(21,0,0))),
        (int)float(tArA(make_coord(22,0,0))),(int)float(tArA(make_coord(23,0,0))),
        (int)float(tBrB(make_coord(0,0,0))),(int)float(tBrB(make_coord(1,0,0))),
        (int)float(tBrB(make_coord(2,0,0))),(int)float(tBrB(make_coord(3,0,0))),
        (int)float(tBrB(make_coord(4,0,0))),(int)float(tBrB(make_coord(5,0,0))),
        (int)float(tBrB(make_coord(6,0,0))),(int)float(tBrB(make_coord(7,0,0))));
  ...
  for (int m_tile = 0; m_tile < NTilesM; ++m_tile) {
    ...
    for (int n_tile = 0; n_tile < NTilesN; ++n_tile) {
      ...
      for (int k_tile = 0; k_tile < NTilesK; ++k_tile) {
        ...
        if (thread0()) {
          print("m_tile: ");print(m_tile); print(" n_tile: ");print(n_tile);print(" k_tile: ");print(k_tile);printf("\n");
          print_tensor(tArA); printf("\n");
          print_tensor(tBrB); printf("\n");
        }
        #pragma unroll
...
struct KernelSpec {
  ...
  using MMATileLayout = Tile<Int<kMmaTileM>,
                          Int<kMmaTileN>,
                          Int<kMmaTileK>>;
  using TiledMMA = decltype(make_tiled_mma(MMA_atom{}, MMAThrLayout{}, MMATileLayout{}));
...
run_block_mma(const torch::Tensor a,
  ...
  print_tile_svg(typename Spec::MMA_atom{});
  cute::print(typename Spec::MMA_atom{});
  print_tile_svg(typename Spec::TiledMMA{});
  cute::print(typename Spec::TiledMMA{});

  print_tile_svg(typename Spec::TiledCopyA{},"TiledCopyA");
  cute::print(typename Spec::TiledCopyA{});
  print_tile_svg(typename Spec::TiledCopyB{},"TiledCopyB");
  cute::print(typename Spec::TiledCopyB{});
