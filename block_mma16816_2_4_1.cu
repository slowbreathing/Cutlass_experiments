...
#else
  constexpr int kMmaValExpandM = Spec::kMmaValExpandM; //1
  constexpr int kMmaValExpandN = Spec::kMmaValExpandN; //1
  constexpr int kMmaValExpandK = Spec::kMmaValExpandK; //1

  constexpr int kMmaTileM = Spec::kMmaTileM; //32
  constexpr int kMmaTileN = Spec::kMmaTileN; //32
  constexpr int kMmaTileK = Spec::kMmaTileK; //16

  constexpr int NTilesM = kTileM / kMmaTileM; //128/32=4
  constexpr int NTilesN = kTileN / kMmaTileN; //128/32=4
  constexpr int NTilesK = kTileK / kMmaTileK; //64/14=4
